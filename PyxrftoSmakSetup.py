...
def PyxrftoSmak(pyxrfdir=srxdatadir.dfpyxrffoutdir, infile=None, fileprefix=None, foutdir=srxdatadir.dfsmakoutdir, filenum=0, 
                comments = '', i0f=1.0, filenameadd='', fitdata='detsum', noyear = False, notimeout=False, patchfile=False):
    print 'input file directory:', pyxrfdir

    ''''
    E.g. fitdata = 'det2' if fitted data is for ch2
    '''
    ...
    if fitdata != 'detsum' and fitdata != 'det1' and fitdata != 'det2' and fitdata != 'det3' :
       print 'fitdata must = detsum, det1, det2, or det3'
       return 7, errorcodedef
    comments = 'detector channel fitted:' + fitdata + ';' + comments
    ...
    if patchfile == True:
        fout=foutdir+fileprefix+'_patch_smak_'+fitdata+filenameadd+'.dat'       
    else:
        fout=foutdir+fileprefix+'_smak_'+fitdata+filenameadd+'.dat'   
