...
for element in datalogDic:
    ...
    if usesdd == True:
        ...
        rawx, rawy, scanproperty = srxpeak.dataread(fileprefix=datalogDic[element], scriptname='srx-coord-energy-timeout-e.py', 
                                      xcol = 3, ycol = 8, chalist = [',', '(',')','[',']',':'])
        rawy = -numpy.log(rawy-baseline)          
