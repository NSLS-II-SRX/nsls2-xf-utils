...
#   count=0
    ...
    for x in range(0,pN):
        ...
        if options.sim is False:
            ...
            signal3=0.
        if options.sim is False:    
            str=' E= %(E)8.3f B= %(B)8.4f U= %(U)8.4f G= %(G)8.3f : %(C0)10.7e %(C1)10.7e %(C2)10.7e %(C3)10.7e TRAJ %(OX)6.3f %(OY)6.3f %(AX)6.3f %(AY)6.3f %(T)d'%{"E":12.3984/(2*d111*np.sin((bmot_cur.get()+dBragg)*np.pi/180)), "B":float(bmot_cur.get()), "U":float(umot_cur.get()), "G":float(gmot_cur.get()), "C0":signal0, "C1":signal1, "C2":signal2, "C3":signal3, "OX":ox,"AX":ax,"OY":oy,"AY":ay, 'T':time.time()}
            print str
            fp.write(str)
            fp.write('\n')
        else:
            str=' E= %(E)8.3f B= %(B)8.4f U= %(U)8.4f G= %(G)8.3f : %(C0)10.7e %(C1)10.7e %(C2)10.7e %(C3)10.7e TRAJ %(OX)6.3f %(OY)6.3f %(AX)6.3f %(AY)6.3f'%{"E":12.3984/(2*d111*np.sin((bmot_cur.get()+dBragg)*np.pi/180)), "B":tar[0][0], "U":tar[1][0], "G":tar[2][0], "C0":signal0, "C1":signal1, "C2":signal2, "C3":signal3, "OX":ox,"AX":ax,"OY":oy,"AY":ay} 
            print str
            fp.write(str)
            fp.write('\n')
