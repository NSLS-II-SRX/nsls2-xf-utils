...
def srxfftomo_correction(datapath = filepath_sc,
                    dfprefix = sample1_df, 
    ...
    if save_corrected_tiff is True:
        outputfile_tiff = outpath + samplename + '/' + samplename + output_tiff_prefix + '_corrected.tiff'
...
def srxfftomo_findcenter(corrected_proj_tiff = None, proj = None, 
                            ...
                            outpath = out_filepath, samplename = sample1_name):
...
def srxfftomo_recon(proj, rot_center = sample1_center, recon_algorithm = 'art', recon_section = None,
                    outpath = out_filepath, recon_outpath = 'recon', samplename = sample1_name):
